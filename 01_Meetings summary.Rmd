...
## **Meeting Mike 15/08/2025**

<details>
  <summary style=font-size:16px>*Things to talk about*</summary>

* Inductions and things to do: e.g. competence certificate
      Introduction in the ethics system done by Mike        
      I will need to do an animals ethics quiz       
      Competence later          
      *Connect Once Drive to flinders account to get access to the main share drive*              
      Get ResearchNow profile          
      Get VPN and check printer           
      Hire cars: fleet 54 or 17 (17 better under bad conditions)         
        - Other vehicles also for our lab, but mainly for other projects.      
      Fieldwork forms have to be done        
      I need first aids course (email sent)           
      
* Fieldwork: general ideas (when to start, etc.). Check summary and other things, especially the folder once you get it             
* Fielwork: what to do. New experiments?         
* HDMI cable - check post office              
...
<details>
  ...
  <summary style=font-size:16px>*Things to do*</summary>

* **Pair-bonding**
  + Program fieldwork        
  + Check data?          
* **PreyD**
  + Analyses controlling by mit density
  + Re-write discussion
* **CORT and learning meta-analysis**  
  + Finish data extraction      
  + Statistical analyses   
...
## **Meeting fieldwork 09/09/2025**
Participants: Mike Gardner, Ondi Crino, & Pablo Recio         

<details>
  <summary style=font-size:16px>*Things to talk about*</summary>        
        
**Research Plan – Social Neuroendocrinology of Pairing Behaviour**         

  Plan for 2025 (what PR would do):      

  Priority 1: measure circulating levels of MT, dopamine (D), arginine vasotocin (AVT), and corticosterone (CORT).            

  Priority 2: Treat pairs in the wild and record affiliative behaviour: pairs receiving agonists, pairs receiving saline, and pairs receiving antagonists.         

  Priority 3: Bring animals to the laboratory to develop or refine the agonist dosing protocols, as well as pilot tests for measuring brain hormone levels.       
  
  Other options: measure affiliative behaviour and hormones in pairs over the field season (together with paired/unpaired hormone levels).            
  
  *Full text on PR's computer: Desktop/PROJECTS/WORK_ON/Research Plan 2025.docx*       
         
         
**Specific questions**           
<ul>
  <li>How to take blood?
    <ul>
      <li>Do I need heparinised syringes and needles or not?</li>
      <li>Should we freeze samples? If so, cryopreserver?</li>
      <li>How long could the samples stay frozen?</li>
    </ul>
  </li>
  <li>Do we have ethics for other experiments? E.g.: mate choice after antagonist</li>
  <li>Do we have the antagonists and the agonists ready?
    <p><span style="color:darkblue">According to Lynea's email, we have the agonists but not the protocol; we don't have the antagonists, but we have the protocol for them.</span></p>
  </li>
</ul>            
...
<details> 
  <summary style=font-size:16px>*Decisions made*</summary>


**2025 Research plan**       

Focus on measuring circulating hormones from paired and unpaired animals. Then use the proximity sensors in some pairs and track them during several weeks while we take blood for hormone measurements              
...
* **Pair-bonding**
  + Practice blood        
  + Check blood sampling protocols Lynea (send email)           
  + Organise radiotrackeers            
  + Check proximity sensors and charge          
* **CORT and learning meta-analysis**  
  + Finish data extraction      
  + Statistical analyses       
  + Write    
