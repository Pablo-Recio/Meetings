...
* When you share the project, the collaborators are blind to your decisions unless you select a different option in the general screen ('BLIND ON' button)  
* When doing the first screening to see consistency, is better to make a decision on 100 or more ("Maybe" does not count). On Rayyan, if you go to the left side panel, under “Minimum collaborator decisions” and click on “At least 1” those are the papers the creator has screened.  
...
<details>
  <summary style=font-size:15px> Proposed deadlines </summary>  

  1. Screening the first 100 papers and see consistency  
    DEADLINE: 21/10/2022 | Meeting: 31/10/2022
  2. Screening the rest of the abstracts (approx 800/person)
    DEADLINE: 02/12/2022 | Meeting: 02/12/2022
