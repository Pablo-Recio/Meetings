...
<span style="color: darkgreen">
  ...
  + Bought more containers from Coles (arriving on 26/09)
</span>
</details>
...
<span style="color: darkgreen">
  + 2 bought from Riotstores on 23/09/2022); left in *EcolPhysiol Lab* with the personality objects  
</span>
</details>
...
<span style="color: darkgreen">
  ...
  + We will need 96 blocks per color - 288 in total 
</span>
...
<span style="color: darkgreen">
  + Plastic glass or similar	2 per individual = 200 approx - **Found at *EcolPhysiol Lab* in Robertson Building**
  + Filter paper	
</span>
...
<span style="color: darkgreen">
  ...
  + List of canned food available (Lab in Robertson Building 3rd green drawer under the table in the middle of the room):  
    ...
    - Artemia [1 can]  
    - Mealworms [3 cans] 
  + **Buy 30 cans of Mealworms, Crickets, Grashoppers, and Silkworms**
</span> 
...
* Filter paper, double-sided tape, sand or similar, cardboard or similar (FOR WALLS?)  
    - <span style="color: darkgreen"> Tape bought from Riotstores, check the rest of the material </span>
</details>
